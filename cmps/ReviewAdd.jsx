    ...
    return (
      <section className="add-review">
        ...
        <form onSubmit={(ev)=> {this.props.onSubmit(ev,this.state.review)}}>
          ...
          <input id="name" name="name" type="text" onChange={this.handleChange} value={name} placeholder="Your Name" required/>
          <div className="selection">
            <label htmlFor="name">Rating</label>
            <select onChange="" value={rate} onChange={this.handleChange} name="rate" required>
          ...
          <input type="date" name="readDate" id="readDate" value={readDate} onChange={this.handleChange} required/>
          <label htmlFor="txt">What's your opinion ?</label>
          <textarea placeholder="What you thought about the book.."
            name="txt"
            id="txt"
            cols="30"
            rows="5"
